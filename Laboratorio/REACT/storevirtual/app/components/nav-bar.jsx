...
const navBar = () =>{
    ...
    const activeStyle = linkhref+ ' bg-amber-300';
    ...
    return (
        ...
        <Link href='/dashboard' className={(currentRoute === '/dashboard') ? activeStyle : inactiveStyle}>Dashboard</Link>
        <Link href='/contact' className={(currentRoute === '/contact') ? activeStyle : inactiveStyle}>Contacto</Link>
        </nav>    
    );
}
